...
class User < ApplicationRecord
  ...
  has_many(:accepted_sent_follow_request, -> {where(status: "accepted")}, class_name: "FollowRequest", foregin_key: "sender_id")
  has_many(:accepted_received_follow_request, -> {where(status: "accepted")}, class_name: "FollowRequest", foregin_key: "recipient_id")
